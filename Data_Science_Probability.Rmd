...
To find the value of $n$ for which $z$ is less than or equal to our desired value, we take $z \le - \frac{n \mu}{\sqrt{n \sigma}) = - \frac {\sqrt{n \mu}{\sigma}$ and solve for $n$:
...
8Code: Monte Carlo simulation with unknown default probability*
