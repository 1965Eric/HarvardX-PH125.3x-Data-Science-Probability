...
This course corresponds to the Probability section of textbook, starting [here](https://rafalab.github.io/dsbook/probability.html){target="_blank"}.
...
The textbook for this section is available [here](https://rafalab.github.io/dsbook/probability.html#discrete-probability){target="_blank"}.
...
$\mbox{Pr}(A)$ = probability of event A
...
The textbook for this section is available [here](https://rafalab.github.io/dsbook/probability.html#monte-carlo-simulations){target="_blank"}.
...
The textbook for this section is available [here](https://rafalab.github.io/dsbook/probability.html#discrete-probability-distributions){target="_blank"}.
...
The textbook section on independence, conditional probability and the multiplication rule is available [here](https://rafalab.github.io/dsbook/probability.html#independence){target="_blank"}.
...
$\mbox{Pr}(\text{Card 2 is a king} \mid \text{Card 1 is a king}) = 3/51$
...
$\mbox{Pr}(\text{A and B and C}) = \mbox{Pr}(A)\:X\:\mbox{Pr}(B)\:X\:\mbox{Pr}(C)$ 

The multiplication rule for dependent events considers the conditional probability of both events occurring:

$\mbox{Pr}(\text{A and B}) = \mbox{Pr}(A)\:X\:\mbox{Pr}(B \mid A)$

We can expand the multiplication rule for dependent events to more than 2 events:

$\mbox{Pr}(\text{A and B and C}) = \mbox{Pr}(A)\:X\:\mbox{Pr}(B \mid A)\:X\:\mbox{Pr}(C \mid \text{A and B})$
...
The textbook for this section is available [here](https://rafalab.github.io/dsbook/probability.html#combinations-and-permutations){target="_blank"}.
...
The textbook for this section is available [here](https://rafalab.github.io/dsbook/probability.html#birthday-problem){target="_blank"}.
...
The textbook discussion of the basics of **sapply** can be found [in this textbook section](https://rafalab.github.io/dsbook/programming-basics.html#vectorization){target="_blank"}.

The textbook discussion of **sapply** for the birthday problem can be found within [the birthday problem section](https://rafalab.github.io/dsbook/probability.html#birthday-problem){target="_blank"}.
...
$\mbox{Pr}(event) = 1 - \mbox{Pr}(\text{no event})$

* We can compute the probability of shared birthdays mathematically:

$\mbox{Pr}(\text{shared birthdays}) = 1 − \mbox{Pr}(\text{no shared birthdays}) = 1 − (1\:X\: \frac{364}{365}\:X \:\frac{363}{365}\:X...X\: \frac{365−n+1}{365})$ 
...
Here is a link to the [matching textbook section](https://rafalab.github.io/dsbook/probability.html#infinity-in-practice){target="_blank"}.
...
$\mbox{Pr}(\text{A and B}) = \mbox{Pr}(A)P(B)$
...
Here is a link to the textbook section on the [addition rule](https://rafalab.github.io/dsbook/probability.html#addition-rule){target="_blank"}.
...
$\mbox{Pr}(\text{A or B})=\mbox{Pr}(A) + \mbox{Pr}(B) − \mbox{Pr}(\text{A and B})$

Note that $(\text{A or B})$ is equivalent to $(A \mid B)$.

*Example: The addition rule for a natural 21 in blackjack*

We apply the addition rule where $A$ = drawing an ace then a facecard and $B$ = drawing a facecard then an ace. Note that in this case, both events A and B cannot happen at the same time, so $\mbox{Pr}(\text{A and B}) = 0$.

$\mbox{Pr}(\text{ace then facecard}) = \frac{4}{52}\:X\: \frac{16}{51}$ 

$\mbox{Pr}(\text{facecard then ace}) = \frac{16}{52}\:X\: \frac{4}{51}$

$\mbox{Pr}(\text{ace then facecard} \mid \text{facecard then ace}) = \frac{4}{52}\:X\: \frac{16}{51} + \frac{16}{52}\:X\: \frac{4}{51} = 0.0483$  

## The Monty Hall Problem

Here is the textbook section on the [Monty Hall Problem](https://rafalab.github.io/dsbook/probability.html#monty-hall-problem){target="_blank"}.
...
* For more on the Monty Hall problem, you can [watch a detailed explanation here](https://www.khanacademy.org/math/precalculus/prob-comb/dependent-events-precalc/v/monty-hall-problem){target="_blank"} or [read an explanation here](https://en.wikipedia.org/wiki/Monty_Hall_problem){target="_blank"}.
...
The textbook for this section is available [here](https://rafalab.github.io/dsbook/probability.html#continuous-probability){target="_blank"}.

The previous discussion of CDF is from the Data Visualization course. Here is the [textbook section on the CDF](https://rafalab.github.io/dsbook/distributions.html#cdf-intro){target="_blank"}.
...
$\mbox{Pr}(x > 70.5) = 1 − \mbox{Pr}(x \le 70.5) = 1 − F(70.5)$ 
...
The textbook for this section is available [here](https://rafalab.github.io/dsbook/probability.html#theoretical-continuous-distributions){target="_blank"}.
...
The textbook for this section is available [here](https://rafalab.github.io/dsbook/probability.html#the-probability-density){target="_blank"}.
...
$F(a) = \mbox{Pr}(X \le a) = \int_{-\infty}^{a} f(x)dx$
...
The textbook for this section is available [here](https://rafalab.github.io/dsbook/probability.html#monte-carlo-simulations-for-continuous-variables){target="_blank"}.
...
The textbook for this section is available [here](https://rafalab.github.io/dsbook/probability.html#continuous-distributions){target="_blank"}.
...
Convert **act_scores** to Z-scores. Recall from [Data Visualization](https://www.edx.org/course/data-science-visualization){target="_blank"} (the second course in this series) that to standardize values (convert values into Z-scores, that is, values distributed with a mean of 0 and standard deviation of 1), you must subtract the mean and then divide by the standard deviation. Use the mean and standard deviation of **act_scores**, not the original values used to generate random test scores.
...
The textbook for this section is available [here](https://rafalab.github.io/dsbook/random-variables.html#random-variables-1){target="_blank"}.
...
The textbook for this section is available [here](https://rafalab.github.io/dsbook/random-variables.html#sampling-models){target="_blank"}.
...
The textbook for this section is available [here](https://rafalab.github.io/dsbook/random-variables.html#distributions-versus-probability-distributions){target="_blank"}.
...
The textbook for this section is available [here](https://rafalab.github.io/dsbook/random-variables.html#notation-for-random-variables){target="_blank"}.
...
The textbook for this section is available [here](https://rafalab.github.io/dsbook/random-variables.html#the-expected-value-and-standard-error){target="_blank"} and [here](https://rafalab.github.io/dsbook/random-variables.html#central-limit-theorem){target="_blank"}.
...
The textbook for this section is available [here](https://rafalab.github.io/dsbook/random-variables.html#statistical-properties-of-averages){target="_blank"}.
...
The textbook for this section is available [here](https://rafalab.github.io/dsbook/random-variables.html#law-of-large-numbers){target="_blank"}.
...
The textbook for this section is available [here](https://rafalab.github.io/dsbook/random-variables.html#how-large-is-large-in-the-central-limit-theorem){target="_blank"}.

You can read more about the Poisson distribution at [this link](https://en.wikipedia.org/wiki/Poisson_distribution){target="_blank"}.
...
3g. Use ```pnorm``` with the expected value of the sum and standard error of the sum to calculate the probability of losing money over 500 bets, $\mbox{Pr}(X \le 0)$.
...
The textbook for this section is available [here](https://rafalab.github.io/dsbook/random-variables.html#case-study-the-big-short){target="_blank"}.
...
The textbook for this section is available [here](https://rafalab.github.io/dsbook/random-variables.html#the-big-short){target="_blank"}.
...
$\mbox{Pr}(\frac{S−E \left [S \right ]}{SE \left [S \right ]} < \frac{−E \left [S \right ]}{SE \left [S \right ]})$
...
We will use data from 2015 [US Period Life Tables](https://www.ssa.gov/oact/STATS/table4c6.html){target="_blank"}. Here is the code you will need to load and examine the data from **dslabs**:
...
#### 1. and 2. Insurance rates, part 1
