...
\includegraphics{Data_Science_Probability_files/figure-latex/unnamed-chunk-65-1.pdf}
...
\includegraphics{Data_Science_Probability_files/figure-latex/unnamed-chunk-66-1.pdf}
...
\includegraphics{Data_Science_Probability_files/figure-latex/unnamed-chunk-68-1.pdf}
...
\includegraphics{Data_Science_Probability_files/figure-latex/unnamed-chunk-75-1.pdf}
...
\includegraphics{Data_Science_Probability_files/figure-latex/unnamed-chunk-81-1.pdf}
...
\includegraphics{Data_Science_Probability_files/figure-latex/unnamed-chunk-88-1.pdf}
...
\includegraphics{Data_Science_Probability_files/figure-latex/unnamed-chunk-92-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Calculate the proportion of outcomes in the vector \textasciigrave{}S\textasciigrave{} that exceed $0}
\KeywordTok{mean}\NormalTok{(S }\OperatorTok{\textgreater{}}\StringTok{ }\DecValTok{0}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# We defined the average using the following code}
\NormalTok{avg \textless{}{-}}\StringTok{ }\DecValTok{17}\OperatorTok{*}\NormalTok{p\_green }\OperatorTok{+}\StringTok{ }\DecValTok{{-}1}\OperatorTok{*}\NormalTok{p\_not\_green}

\CommentTok{\# We defined standard error using this equation}
\NormalTok{se \textless{}{-}}\StringTok{ }\DecValTok{1}\OperatorTok{/}\KeywordTok{sqrt}\NormalTok{(n) }\OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{17} \OperatorTok{{-}}\StringTok{ }\DecValTok{{-}1}\NormalTok{)}\OperatorTok{*}\KeywordTok{sqrt}\NormalTok{(p\_green}\OperatorTok{*}\NormalTok{p\_not\_green)}

\CommentTok{\# Given this average and standard error, determine the probability of winning more than $0. Print the result to the console.}
\DecValTok{1}\OperatorTok{{-}}\KeywordTok{pnorm}\NormalTok{(}\DecValTok{0}\NormalTok{,avg,se)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Compute the proportion of outcomes in the vector \textquotesingle{}S\textquotesingle{} where you won more than $0}
\KeywordTok{mean}\NormalTok{(S}\OperatorTok{\textgreater{}}\DecValTok{0}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
